...
const saveKey = 'prize-arrival-watch.saved'
const postKey = 'prize-arrival-watch.posts'
const alerts = [
  {
    "id": "prize-arrival-watch-1",
    "title": "入荷 alert seed 1",
    "area": "名古屋",
    "category": "入荷",
    "score": 95,
    "summary": "景品名、キャラ名、店舗名で入荷、在庫、再入荷を通知し、ゲームセンター掲載とEC送客へつなげる。 入荷の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  {
    "id": "prize-arrival-watch-2",
    "title": "在庫 alert seed 2",
    "area": "東京",
    "category": "在庫",
    "score": 92,
    "summary": "景品名、キャラ名、店舗名で入荷、在庫、再入荷を通知し、ゲームセンター掲載とEC送客へつなげる。 在庫の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール"
  ...
  {
    "id": "prize-arrival-watch-3",
    "title": "再入荷 alert seed 3",
    "area": "大阪",
    "category": "再入荷",
    "score": 89,
    "summary": "景品名、キャラ名、店舗名で入荷、在庫、再入荷を通知し、ゲームセンター掲載とEC送客へつなげる。 再入荷の条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X",
      "メール",
  ...
  {
    "id": "prize-arrival-watch-4",
    "title": "フィギュア alert seed 4",
    "area": "静岡",
    "category": "フィギュア",
    "score": 86,
    "summary": "景品名、キャラ名、店舗名で入荷、在庫、再入荷を通知し、ゲームセンター掲載とEC送客へつなげる。 フィギュアの条件一致時に通知し、保存、送客、課金へつなげます。",
    "channels": [
      "LINE",
      "X"
    ],
  ...
  return (
    <main className="app-shell">
      <section className="hero">
        <div>
          <p className="eyebrow">プライズ景品の入荷・在庫通知</p>
          <h1>Prize Arrival Watch</h1>
          <p className="lead">景品名、キャラ名、店舗名で入荷、在庫、再入荷を通知し、ゲームセンター掲載とEC送客へつなげる。</p>
        </div>
        <aside className="hero-panel">
          <span>prizearrival.jp / prize-arrival-watch</span>
